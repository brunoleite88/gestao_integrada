...
class Cache_Lite
{
    ...
    * @access public
    */
    function __construct($opcoes = array(NULL))
    {
    ...
    * @access public
    */
    function get($id, $grupo = 'default', $doNotTestCacheValidity = false)
    {
        $this->_id = $id;
        $this->_grupo = $grupo;
        $data = false;
    ...
    * @access public
    */
    function save($data, $id = NULL, $grupo = 'default')
    {
        if ($this->_caching) {
            if ($this->_automaticSerialization) {
                $data = serialize($data);
    ...
    * @access public
    */
    function remove($id, $grupo = 'default')
    {
        $this->_setFileName($id, $grupo);
        if ($this->_memoryCaching) {
            if (isset($this->_memoryCachingArray[$this->_file])) {
    ...
    * @access public
    */
    function setLifeTime($novoLifeTime)
    {
    ...
    * @access public
    */
    function saveMemoryCachingState($id, $grupo = 'default')
    {
        if ($this->_caching) {
            $array = array(
    ...
    * @access public
    */
    function getMemoryCachingState($id, $grupo = 'default', $doNotTestCacheValidity = false)
    {
        if ($this->_caching) {
