...
class LDAPAutenticador extends SQLAutenticador {
	...
	function atualizaUsuarioSql($usuarioNome, $ldap_atributo = array()) {
		...
		$contato_nomecompleto = (isset($ldap_atributo[$config['ldap_nomecompleto']][0]) ? ($config['ldap_charset']=='utf8' ? gpw_passthrough($ldap_atributo[$config['ldap_nomecompleto']][0]) : $ldap_atributo[$config['ldap_nomecompleto']][0]) : null);
		if (!$contato_nomecompleto) $contato_nomecompleto = (isset($ldap_atributo[strtolower($config['ldap_nomecompleto'])][0]) ? ($config['ldap_charset']=='utf8' ? gpw_passthrough($ldap_atributo[strtolower($config['ldap_nomecompleto'])][0]) : $ldap_atributo[strtolower($config['ldap_nomecompleto'])][0]) : null);
		
		$contato_nomeguerra = (isset($ldap_atributo[$config['ldap_nomeguerra']][0]) ? ($config['ldap_charset']=='utf8' ? gpw_passthrough($ldap_atributo[$config['ldap_nomeguerra']][0]) : $ldap_atributo[$config['ldap_nomeguerra']][0]) : null);
		if (!$contato_nomeguerra) $contato_nomeguerra = (isset($ldap_atributo[strtolower($config['ldap_nomeguerra'])][0]) ? ($config['ldap_charset']=='utf8' ? gpw_passthrough($ldap_atributo[strtolower($config['ldap_nomeguerra'])][0]) : $ldap_atributo[strtolower($config['ldap_nomeguerra'])][0]) : null);
		
		$contato_email = (isset($ldap_atributo[$config['ldap_email']][0]) ? ($config['ldap_charset']=='utf8' ? gpw_passthrough($ldap_atributo[$config['ldap_email']][0]) : $ldap_atributo[$config['ldap_email']][0]) : null);
		if (!$contato_email) $contato_email = (isset($ldap_atributo[strtolower($config['ldap_email'])][0]) ? ($config['ldap_charset']=='utf8' ? gpw_passthrough($ldap_atributo[strtolower($config['ldap_email'])][0]) : $ldap_atributo[strtolower($config['ldap_email'])][0]) : null);
		...
		$contato_funcao = (isset($ldap_atributo[$config['ldap_funcao']][0]) ? ($config['ldap_charset']=='utf8' ? gpw_passthrough($ldap_atributo[$config['ldap_funcao']][0]) : $ldap_atributo[$config['ldap_funcao']][0]) : null);
		if (!$contato_funcao) $contato_funcao = (isset($ldap_atributo[strtolower($config['ldap_funcao'])][0]) ? ($config['ldap_charset']=='utf8' ? gpw_passthrough($ldap_atributo[strtolower($config['ldap_funcao'])][0]) : $ldap_atributo[strtolower($config['ldap_funcao'])][0]) : null);
		
		$contato_cpf = (isset($ldap_atributo['cpf']) ? $ldap_atributo['cpf'][0] : NULL);
		$contato_matricula = (isset($ldap_atributo['employeenumber']) ? ($config['ldap_charset']=='utf8' ? gpw_passthrough($ldap_atributo['employeenumber'][0]) : $ldap_atributo['employeenumber'][0]) : NULL);
	...
	function criarUsuarioSql($usuarioNome, $ldap_atributo = array()) {
		...
		$c->contato_nomecompleto = (isset($ldap_atributo[$config['ldap_nomecompleto']][0]) ? ($config['ldap_charset']=='utf8' ? gpw_passthrough($ldap_atributo[$config['ldap_nomecompleto']][0]) : $ldap_atributo[$config['ldap_nomecompleto']][0]) : null);
		if (!$c->contato_nomecompleto) $c->contato_nomecompleto = (isset($ldap_atributo[strtolower($config['ldap_nomecompleto'])][0]) ? ($config['ldap_charset']=='utf8' ? gpw_passthrough($ldap_atributo[strtolower($config['ldap_nomecompleto'])][0]) : $ldap_atributo[strtolower($config['ldap_nomecompleto'])][0]) : null);
		
		$c->contato_nomeguerra = (isset($ldap_atributo[$config['ldap_nomeguerra']][0]) ? ($config['ldap_charset']=='utf8' ? gpw_passthrough($ldap_atributo[$config['ldap_nomeguerra']][0]) : $ldap_atributo[$config['ldap_nomeguerra']][0]) : null);
		if (!$c->contato_nomeguerra) $c->contato_nomeguerra = (isset($ldap_atributo[strtolower($config['ldap_nomeguerra'])][0]) ? ($config['ldap_charset']=='utf8' ? gpw_passthrough($ldap_atributo[strtolower($config['ldap_nomeguerra'])][0]) : $ldap_atributo[strtolower($config['ldap_nomeguerra'])][0]) : null);
		
		$c->contato_email = (isset($ldap_atributo[$config['ldap_email']][0]) ? ($config['ldap_charset']=='utf8' ? gpw_passthrough($ldap_atributo[$config['ldap_email']][0]) : $ldap_atributo[$config['ldap_email']][0]) : null);
		if (!$c->contato_email) $c->contato_email = (isset($ldap_atributo[strtolower($config['ldap_email'])][0]) ? ($config['ldap_charset']=='utf8' ? gpw_passthrough($ldap_atributo[strtolower($config['ldap_email'])][0]) : $ldap_atributo[strtolower($config['ldap_email'])][0]) : null);
		...
		$c->contato_funcao = (isset($ldap_atributo[$config['ldap_funcao']][0]) ? ($config['ldap_charset']=='utf8' ? gpw_passthrough($ldap_atributo[$config['ldap_funcao']][0]) : $ldap_atributo[$config['ldap_funcao']][0]) : null);
		if (!$c->contato_funcao) $c->contato_funcao = (isset($ldap_atributo[strtolower($config['ldap_funcao'])][0]) ? ($config['ldap_charset']=='utf8' ? gpw_passthrough($ldap_atributo[strtolower($config['ldap_funcao'])][0]) : $ldap_atributo[strtolower($config['ldap_funcao'])][0]) : null);
		
		$c->contato_cpf = (isset($ldap_atributo['cpf']) ? $ldap_atributo['cpf'][0] : NULL);
		$c->contato_matricula = (isset($ldap_atributo['employeenumber']) ? ($config['ldap_charset']=='utf8' ? gpw_passthrough($ldap_atributo['employeenumber'][0]) : $ldap_atributo['employeenumber'][0]) : NULL);
