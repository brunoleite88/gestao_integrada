...
$semana=array('Monday'=>'S', 'Tuesday'=>'T', 'Wednesday'=>'Q', 'Thursday'=>'Q', 'Friday'=>'S', 'Saturday'=>'S', 'Sunday'=>'D'); 
$mes=array('Jan'=>'Jan', 'Feb'=>'Fev', 'Mar'=>'Mar', 'Apr'=>'Abr', 'May'=>'Mai', 'Jun'=>'Jun', 'Jul'=>'Jul', 'Aug'=>'Ago', 'Sep'=>'Set', 'Oct'=>'Out', 'Nov'=>'Nov', 'Dec'=>'Dez'); 
            ...
            for($i=0; $i < $this->GetNumberOfDays(); ++$i, $x+=$daywidth, $day += 1,$day %= 7) {
                ...
                switch( $this->day->iStyle ) {
                    ...
                    default:
                        // "M"
                         $txt = strftime('%A',$datestamp);
												if (isset($semana[$txt]))$txt=$semana[$txt]; 
												else $txt =$txt[0];       
                        break;
                }
