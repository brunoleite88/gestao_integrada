...
class  ADODB_afazer_mssql extends ADODB_ado {        
	var $databaseType = 'afazer_mssql';
	var $hasTop = 'top';
	...
	class  ADORecordSet_afazer_mssql extends ADORecordSet_ado {        
	
	var $databaseType = 'afazer_mssql';
	
	function ADORecordSet_afazer_mssql($id,$modo=false)
	{
