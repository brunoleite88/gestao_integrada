...
class  ADODB_afazer_access extends ADODB_ado {	
	var $databaseType = 'afazer_access';
...
class  ADORecordSet_afazer_access extends ADORecordSet_ado {	
	
	var $databaseType = "afazer_access";		
	
	function ADORecordSet_afazer_access($id,$modo=false)
	{
		return $this->ADORecordSet_ado($id,$modo);
	}
}
?>
