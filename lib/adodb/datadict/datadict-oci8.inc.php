...
class ADODB2_oci8 extends ADODB_DataDict {
	...
	function MetaType($t,$tamanho=-1)
	{
		...
		case 'NVARCHAR2':
		case 'NVARCHAR':
			if (isset($this) && $tamanho <= $this->blobSize) return 'C2';
			return 'X2';
	...
	function CreateDatabase($nomeBd, $options=false)
	{
		...
		$sql[] = "CREATE USER ".$nomeBd." IDENTIFIED BY ".$password.$tablespace;
		$sql[] = "GRANT CREATE SESSION, CREATE TABLE,UNLIMITED TABLESPACE,CREATE SEQUENCE TO $nomeBd";
	...
	function _CreateSuffix($fnome,$ftype,$fnotnull,$fdefault,$fautoinc,$fconstraint,$funsigned)
	{
		$sufixo = '';
		...
		if ($fautoinc) $this->seqField = $fnome;
...
*/
	...
	CREATE [TEMPORARY] TABLE [IF NOT EXISTS] tbl_name [(create_definition,...)]
		...
		create_definition:
		col_name type [NOT NULL | NULL] [DEFAULT valor_padrao] [AUTO_INCREMENT]
