...
class ADODB2_sapdb extends ADODB_DataDict {
	...
	function MetaType($t,$tamanho=-1,$fieldobj=false)
	{
		...
		if ($t == 'FIXED' && !$fieldobj->scale && ($tamanho == 20 || $tamanho == 3)) {
			$type = $tamanho == 20 ? 'I8' : 'I1';
		}
	...
	{	
		$sufixo = '';
		if ($funsigned) $sufixo .= ' UNSIGNED';
		if ($fnotnull) $sufixo .= ' NOT NULL';
		if ($fautoinc) $sufixo .= ' DEFAULT SERIAL';
		elseif (strlen($fdefault)) $sufixo .= " DEFAULT $fdefault";
