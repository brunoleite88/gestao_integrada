...
* html #main .example .show-it,* html .show-example ,* html #main .example .show-control-example
{
	width:98%;
}
...
* html img.CoolTreeView
{
	background:none;
	filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='<?php echo $imgURL;?>/CoolTreeView.png', sizingMethod='crop');
}
