...
if (empty ($width)) $width=(strlen($barcode)*31);
...
switch ($type){
        default:
                $type = 1;
        case 1:
                Barcode39 ($barcode, $width, $height, $quality, $format, $text, isset($barcode39_file_name) ? $barcode39_file_name : null);
                break;          
}
...
//-----------------------------------------------------------------------------
function Barcode39 ($barcode, $width, $height, $quality, $format, $text, $file)
{
        switch ($format)
        {
                default:
    ...
    or die ("Cannot Initialize new GD image stream");
        ...
        {
                ImageString ($im, 1, 0, 0, "Imagem muito pequena!", $Black);
        ...
        OutputImage ($im, $format, $quality, $file);
}
...
//-----------------------------------------------------------------------------
function OutputImage ($im, $format, $quality, $file = null)
{
        switch ($format)
        {
                case "JPEG": 
