...
function getoptions() {
  ...
  while ($i < $_SERVER["argc"]) {
    ...
    case "-p":
      ...
      $opts["p"] = previnirXSS($_SERVER["argv"][$i+1]);
      $i += 2;
      break;
    ...
    case "-o":
      ...
      $opts["o"] = previnirXSS($_SERVER["argv"][$i+1]);
      $i += 2;
      break;
    ...
    case "-b":
      ...
      $opts["b"] = previnirXSS($_SERVER["argv"][$i+1]);
      $i += 2;
      break;
    ...
    case "-f":
      ...
      $opts["f"] = previnirXSS($_SERVER["argv"][$i+1]);
      $i += 2;
      break;
    ...
    default:
      $opts["filename"] = previnirXSS($_SERVER["argv"][$i]);
      $i++;
      break;
    }
...
global $_dompdf_mostrar_warnings;
