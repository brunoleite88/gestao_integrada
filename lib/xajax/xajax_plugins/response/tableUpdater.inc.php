...
class clsTableUpdater extends xajaxResponsePlugin
{
	...
	*/
	...
	// tables
	function appendTable($table, $superior) {
		$command = array(
				'cmd'=>'et_at', 
				'id'=>$superior
				);
	...
	function insertTable($table, $superior, $position) {
		$command = array(
				'cmd'=>'et_it', 
				'id'=>$superior, 
				'pos'=>$position
	...
	// rows
	function appendRow($row, $superior, $position = null) {
		$command = array(
				'cmd'=>'et_ar', 
				'id'=>$superior
				);
	...
	function insertRow($row, $superior, $position = null, $before = null) {
		$command = array(
				'cmd'=>'et_ir', 
				'id'=>$superior
				);
	...
	function replaceRow($row, $superior, $position = null, $before = null) {
		$command = array(
				'cmd'=>'et_rr', 
				'id'=>$superior
				);
	...
	function deleteRow($superior, $position = null) {
		$command = array(
				'cmd'=>'et_dr', 
				'id'=>$superior
				);
	...
	function assignRow($values, $superior, $position = null, $start_column = null) {
		$command = array(
				'cmd'=>'et_asr', 
				'id'=>$superior
				);
	...
	function assignRowProperty($property, $value, $superior, $position = null) {
		$command = array(
				'cmd'=>'et_asrp', 
				'id'=>$superior,
				'prop'=>$property
	...
	// columns
	function appendColumn($column, $superior, $position = null) {
		$command = array(
				'cmd'=>'et_acol', 
				'id'=>$superior
				);
	...
	function insertColumn($column, $superior, $position = null) {
		$command = array(
				'cmd'=>'et_icol', 
				'id'=>$superior
				);
	...
	function replaceColumn($column, $superior, $position = null) {
		$command = array(
				'cmd'=>'et_rcol', 
				'id'=>$superior
				);
	...
	function deleteColumn($superior, $position = null) {
		$command = array(
				'cmd'=>'et_dcol', 
				'id'=>$superior
				);
	...
	function assignColumn($values, $superior, $position = null, $start_row = null) {
		$command = array(
				'cmd'=>'et_ascol', 
				'id'=>$superior
				);
	...
	function assignColumnProperty($property, $value, $superior, $position = null) {
		$command = array(
				'cmd'=>'et_ascolp', 
				'id'=>$superior,
				'prop'=>$property
