...
class legacyXajaxResponse extends xajaxResponse {
	...
	function adInserir()			{ $temp=func_get_args(); return call_user_func_array(array(&$this, 'insert'), $temp); }
	function adInserirAfter()		{ $temp=func_get_args(); return call_user_func_array(array(&$this, 'insertAfter'), $temp); }
	function addCreateInput()		{ $temp=func_get_args(); return call_user_func_array(array(&$this, 'createInput'), $temp); }
	function adInserirInput()		{ $temp=func_get_args(); return call_user_func_array(array(&$this, 'insertInput'), $temp); }
	function adInserirInputAfter()	{ $temp=func_get_args(); return call_user_func_array(array(&$this, 'insertInputAfter'), $temp); }
