...
if (!$nomeBd){
	...
	echo '<tr><td align="right">'.dica('Tipo de Caracteres', 'Defina o tipo de caracter da base de dados da qual serão importados os dados.').'Tipo de caracteres:'.dicaF().'</td><td align="left"><input type="radio" name="formatacao" value="utf">UTF-8<input type="radio" name="formatacao" value="8859" checked="checked">utf-8</td></tr>';
...
function formatacao($texto){
	global $formatacao;
	return ($formatacao=='utf' ? gpw_passthrough($texto) : $texto);
	}
