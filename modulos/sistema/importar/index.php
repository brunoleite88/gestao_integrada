...
switch($acao) {
    case 'importar':
	    if ($_FILES['upload_file']['size'] == 0) {
	      ...
	      echo '<tr><td colspan=20><input type="radio" checked="checked" name="formatacao" value="8859">utf-8<input type="radio" name="formatacao" value="utf">UTF-8</td></tr>';
    ...
    default:
      ...
      echo '<tr><td colspan=20><input type="radio" name="formatacao" checked="checked" value="utf">UTF-8<input type="radio" name="formatacao" value="8859">utf-8</td></tr>';
