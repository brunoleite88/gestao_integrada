...
function incluir_lista_ajax(
	...
	$sql = new BDConsulta;
	$campo_customizado_lista_opcao=previnirXSS(gpw_passthrough($campo_customizado_lista_opcao));
	$campo_customizado_lista_valor=previnirXSS(gpw_passthrough($campo_customizado_lista_valor));
	$campo_customizado_lista_cor=previnirXSS(gpw_passthrough($campo_customizado_lista_cor));
	...
	$objResposta->assign("combo_lista","innerHTML", gpw_passthrough($saida));
	return $objResposta;
	}
...
function editar_lista($campo_customizado_lista_id){
	...
	$objResposta->assign("campo_customizado_lista_opcao","value", gpw_passthrough($linha['campo_customizado_lista_opcao']));
	$objResposta->assign("campo_customizado_lista_valor","value", gpw_passthrough($linha['campo_customizado_lista_valor']));
	$objResposta->assign("campo_customizado_lista_cor","value", gpw_passthrough($linha['campo_customizado_lista_cor']));
	$objResposta->assign("teste","style.background", '#'.gpw_passthrough($linha['campo_customizado_lista_cor']));
	return $objResposta;
	}	
