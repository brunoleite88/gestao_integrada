...
function incluir_campo_ajax($sisvalor_titulo='', $sisvalor_id=null, $sisvalor_valor, $sisvalor_valor_id='', $sisvalor_chave_id_pai=''){
	$sql = new BDConsulta;
	$sisvalor_valor=previnirXSS(gpw_passthrough($sisvalor_valor));
	$sisvalor_valor_id=previnirXSS(gpw_passthrough($sisvalor_valor_id));
	$sisvalor_chave_id_pai=previnirXSS(gpw_passthrough($sisvalor_chave_id_pai));
	if ($sisvalor_id){
	...
	$objResposta->assign("campos","innerHTML", gpw_passthrough($saida));
	return $objResposta;
	}
...
function editar_campo($sisvalor_id){
	...
	$objResposta->assign("sisvalor_valor","value", gpw_passthrough($linha['sisvalor_valor']));	
	$objResposta->assign("sisvalor_valor_id","value", gpw_passthrough($linha['sisvalor_valor_id']));	
	$objResposta->assign("sisvalor_chave_id_pai","value", gpw_passthrough($linha['sisvalor_chave_id_pai']));	
	return $objResposta;
	}	
