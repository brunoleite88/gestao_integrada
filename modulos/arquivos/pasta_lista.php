...
if (!$Aplic->checarModulo('arquivo_pastas', 'acesso')) $Aplic->redirecionar('m=publico&a=acesso_negado');
...
if (!$dialogo){
	...
	elseif($swot_id){
		$legenda_filtro=dica('Filtrar pela Matriz SWOT', 'Filtrar as pastas pela matriz SWOT que estão relacionadas.').'Matriz SWOT:'.dicaF();
...
function limpar_tudo(){
	...
	document.frm_filtro.pg_objetivo_estrategico_id .value = null;
	document.frm_filtro.pg_fator_critico_id .value = null;
	...
	<?php 
	if($swot_ativo) echo 'document.frm_filtro.swot_id.value = null;';
...
function setObjetivo(chave, valor){
	limpar_tudo();
	document.frm_filtro.pg_objetivo_estrategico_id.value = chave;
	frm_filtro.submit();
	}	
...
function setFator(chave, valor){
	limpar_tudo();
	document.frm_filtro.pg_fator_critico_id.value = chave;
	frm_filtro.submit();
	}
