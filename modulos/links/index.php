...
if (!$dialogo && $Aplic->profissional){
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$saida.='<tr><td><table cellspacing=0 cellpadding=0>'.$procurar_om.$procurar_usuario.$popFiltro.$filtros.'</table></td><td><table cellspacing=0 cellpadding=0>'.$novo.$botao_prioridade.'</table></td></tr></table>';
	$saida.= '</div></div>';
