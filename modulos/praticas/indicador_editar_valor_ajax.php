...
function excluir_valor($pratica_indicador_valor_id=null, $pratica_indicador_valor_indicador=null){
	...
	$objResposta->assign('combo_valores',"innerHTML", gpw_passthrough($saida));
	return $objResposta;
	}
...
function incluir_valor($pratica_indicador_valor_id=null, $pratica_indicador_valor_indicador=null, $pratica_indicador_valor_responsavel, $pratica_indicador_valor_data, $pratica_indicador_valor_valor, $pratica_indicador_valor_obs){
	...
	if ($pratica_indicador_valor_id){
		...
		$sql->adAtualizar('pratica_indicador_valor_obs', previnirXSS(gpw_passthrough($pratica_indicador_valor_obs)));
		$sql->adOnde('pratica_indicador_valor_id ='.(int)$pratica_indicador_valor_id);	
		$sql->exec();
		}
	else{	
		...
		$sql->adInserir('pratica_indicador_valor_obs', previnirXSS(gpw_passthrough($pratica_indicador_valor_obs)));
		$sql->exec();
		$sql->limpar();
		}
...
function editar_valor($pratica_indicador_valor_id){
	...
	$objResposta->assign("nome_responsavel","value", gpw_passthrough(nome_om(($linha['pratica_indicador_valor_responsavel'] ? $linha['pratica_indicador_valor_responsavel'] : $Aplic->usuario_id),$Aplic->getPref('om_usuario'))));
	...
	$objResposta->assign("pratica_indicador_valor_obs2","value", gpw_passthrough($linha['pratica_indicador_valor_obs']));
	return $objResposta;
	}	
