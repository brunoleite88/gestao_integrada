...
gpweb\modulos\praticas\indicador_ver_marcadores.php		

Exibe os marcadores da pauta de pontuação marcadas para o indicador selecionado																																						
...
if ($marcadores && count($marcadores)) echo '<tr><td align="left" colspan=2 nowrap="nowrap"><p><b>'.ucfirst($config['marcador']).' de Resultado<b></p></td></tr>';
foreach($marcadores as $dado){
	...
	echo '<tr><td align="right" nowrap="nowrap" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>'.$dado['pratica_marcador_letra'].'</b></td><td class="realce" width="100%">'.dica('Informações Extras', $dado['pratica_marcador_extra']).$dado['pratica_marcador_texto'].'</td></tr>';
	}
...
if ($marcadores && count($marcadores)) echo '<tr><td align="left" colspan=2 nowrap="nowrap"><p><b>'.ucfirst($config['marcadores']).' Atendid'.$config['genero_marcador'].'s pel'.$config['genero_pratica'].'s '.$config['praticas'].' que utilizam o indicador<b></p></td></tr>';
else echo '<tr><td align="left" colspan=2 nowrap="nowrap"><p><b>Nenhum'.($config['genero_marcador']=='a'? 'a' : '').' '.$config['marcador'].' encontrad'.$config['genero_marcador'].' para '.$config['praticas'].' com este indicador<b></p></td></tr>';
foreach($marcadores as $dado){
	if ($dado['pratica_criterio_id']!=$criterio_atual){
		$criterio_atual=$dado['pratica_criterio_id'];
		$dentro = '<table cellspacing="4" cellpadding="2" border=0 width="100%">';
