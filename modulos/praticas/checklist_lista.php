...
if (!$dialogo && $Aplic->profissional){
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$saida.='<tr><td><table cellspacing=0 cellpadding=0>'.$procurar_om.$procurar_usuario.$procuraBuffer.$popFiltro.$filtros.'</table></td><td><table cellspacing=0 cellpadding=0>'.$novo_checklist.$imprimir.$botao_favorito.'</table></td></tr></table>';
	$saida.= '</div></div>';
...
if (!$dialogo && !$Aplic->profissional){
	...
	$botoesTitulo->adicionaCelula('<table><tr><td nowrap="nowrap">'.dica('Favoritos', 'Criar ou editar um grupo de checklist favoritos, para uma rápida filtragem.').'<a class="botao" href="javascript: void(0)" onclick="url_passar(0, \'m=publico&a=favoritos&checklist=1\');"><span>favoritos</span></a>'.dicaF().'</td></tr><tr><td nowrap="nowrap">'.$favoritos.'</td></tr></table>');
