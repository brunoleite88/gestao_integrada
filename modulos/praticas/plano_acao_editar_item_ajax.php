...
function exibir($plano_acao_item_acao){
	...
	$objResposta = new xajaxResponse();
	$objResposta->assign("acoes","innerHTML", gpw_passthrough($saida));
	return $objResposta;
	}
...
function incluir_acao_ajax(
	...
	$sql = new BDConsulta;
	$plano_acao_item_nome=previnirXSS(gpw_passthrough($plano_acao_item_nome));
	$plano_acao_item_quando=previnirXSS(gpw_passthrough($plano_acao_item_quando));
	$plano_acao_item_oque=previnirXSS(gpw_passthrough($plano_acao_item_oque));
	$plano_acao_item_como=previnirXSS(gpw_passthrough($plano_acao_item_como));
	$plano_acao_item_onde=previnirXSS(gpw_passthrough($plano_acao_item_onde));
	$plano_acao_item_quanto=previnirXSS(gpw_passthrough($plano_acao_item_quanto));
	$plano_acao_item_porque=previnirXSS(gpw_passthrough($plano_acao_item_porque));
	$plano_acao_item_quem=previnirXSS(gpw_passthrough($plano_acao_item_quem));
...
function editar_acao($plano_acao_item_id){
	...
	$objResposta->assign("nome_responsavel","value", gpw_passthrough(nome_om(($linha['plano_acao_item_responsavel'] ? $linha['plano_acao_item_responsavel'] : $Aplic->usuario_id), $Aplic->getPref('om_usuario'))));
	...
	$objResposta->assign("fim_hora","value", $data->format('%H'));	
	$objResposta->assign("fim_minuto","value", $data->format('%M'));
	$objResposta->assign("plano_acao_item_nome","value", gpw_passthrough($linha['plano_acao_item_nome']));	
	$objResposta->assign("plano_acao_item_quando","value", gpw_passthrough($linha['plano_acao_item_quando']));	
	$objResposta->assign("plano_acao_item_oque","value", gpw_passthrough($linha['plano_acao_item_oque']));	
	$objResposta->assign("plano_acao_item_como","value", gpw_passthrough($linha['plano_acao_item_como']));	
	$objResposta->assign("plano_acao_item_onde","value", gpw_passthrough($linha['plano_acao_item_onde']));	
	$objResposta->assign("plano_acao_item_quanto","value", gpw_passthrough($linha['plano_acao_item_quanto']));	
	$objResposta->assign("plano_acao_item_porque","value", gpw_passthrough($linha['plano_acao_item_porque']));	
	$objResposta->assign("plano_acao_item_quem","value", gpw_passthrough($linha['plano_acao_item_quem']));	
