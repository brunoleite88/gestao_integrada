...
function mudar_posicao_perspectiva($ordem, $objetivo_perspectiva_id, $direcao, $pg_objetivo_estrategico_id=0, $objetivo_perspectiva_uuid=''){
	...
	$objResposta->assign("perspectivas","innerHTML", gpw_passthrough($saida));
	return $objResposta;
	}
...
function atualizar_perspectiva_ajax($cia_id=1, $ano='', $posicao){
	...
	$perspectiva=array();
	foreach ((array)$lista as $linha) $perspectiva[(int)$linha['pg_perspectiva_id']]=gpw_passthrough($linha['pg_perspectiva_nome']);
	$perspectiva[0]='';
