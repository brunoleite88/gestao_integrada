...
if (!$dialogo && $Aplic->profissional){
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$saida.='<tr><td><table cellspacing=0 cellpadding=0>'.$procurar_om.$procurar_usuario.$selecionar_planejamento.$procuraBuffer.'</table></td><td><table cellspacing=0 cellpadding=0>'.$nova_perspectiva.$imprimir.'</table></td></tr></table>';
	$saida.= '</div></div>';
