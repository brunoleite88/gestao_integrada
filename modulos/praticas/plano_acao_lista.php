...
if (count($vetor_favoritos)) {
	$vetor_favoritos[0]='';
	$favoritos=selecionaVetor($vetor_favoritos, 'favorito_id', 'onchange="document.env.submit()" class="texto"', $favorito_id);
	}
...
if (!$dialogo && $Aplic->profissional){
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$novo_plano=($podeAdicionar ? '<tr><td nowrap="nowrap">'.dica('Novo '.ucfirst($config['acao']), 'Criar um nov'.$config['genero_acao'].' '.$config['acao'].'.').'<a href="javascript: void(0)" onclick="javascript:url_passar(0, \'m=praticas&a=plano_acao_editar\');" ><img src="'.acharImagem('plano_acao_novo.png').'" border=0 width="16" heigth="16" /></a>'.dicaF().'</td><tr>' : '');
	$botao_favorito='<tr><td nowrap="nowrap">'.dica('Favoritos', 'Criar ou editar um grupo de planos de ação favoritos, para uma rápida filtragem.').'<a href="javascript: void(0)" onclick="url_passar(0, \'m=publico&a=favoritos&plano_acao=1\');"><img src="'.acharImagem('favorito_p.png').'" border=0 width="16" heigth="16" /></a>'.dicaF().'</td></tr><tr><td nowrap="nowrap">'.$favoritos.'</td></tr>';
	...
	$saida.='<tr><td><table cellspacing=0 cellpadding=0>'.$procurar_om.$procurar_usuario.$procuraBuffer.$procuraAno.$popFiltro.$filtros.'</table></td><td><table cellspacing=0 cellpadding=0>'.$novo_plano.$imprimir.$botao_prioridade.$botao_favorito.'</table></td></tr></table>';
	$saida.= '</div></div>';
...
elseif (!$dialogo&& !$Aplic->profissional){
	...
	$botoesTitulo->adicionaCelula('<table><tr><td nowrap="nowrap">'.dica('Novo '.ucfirst($config['acao']), 'Criar um nov'.$config['genero_acao'].' '.$config['acao'].'.').'<a class="botao" href="javascript: void(0)" onclick="javascript:url_passar(0, \'m=praticas&a=plano_acao_editar\');" ><span>nov'.$config['genero_acao'].'</span></a>'.dicaF().'</td><tr><tr><td nowrap="nowrap">'.dica('Favoritos', 'Criar ou editar um grupo de planos de ação favoritos, para uma rápida filtragem.').'<a class="botao" href="javascript: void(0)" onclick="url_passar(0, \'m=publico&a=favoritos&plano_acao=1\');"><span>favoritos</span></a>'.dicaF().'</td></tr><tr><td nowrap="nowrap">'.$favoritos.'</td></tr></table>');
