...
if (!$dialogo && $Aplic->profissional){
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$saida.='<tr><td><table cellspacing=0 cellpadding=0>'.$procurar_om.$procurar_usuario.$selecionar_planejamento.$filtra_perspectiva.$procuraBuffer.'</table></td><td><table cellspacing=0 cellpadding=0>'.$novo_objetivo.$imprimir.$botao_favorito.'</table></td></tr></table>';
	$saida.= '</div></div>';
