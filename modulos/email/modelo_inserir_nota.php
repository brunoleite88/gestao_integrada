...
echo '<tr><td align="center"><h1>Nota no documento Nº '.$linha['modelo_id'].'<h1></td></tr>';
...
echo '<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;'.dica('Cor','Escolha a cor de fundo desta nota.<br><br>Na tela principal de exibição da lista de '.$config['mensagens'].' é possível ordenar '.$config['genero_mensagem'].'s mesm'.$config['genero_mensagem'].'s pelas cores').'<b>Cor: </b>'.dicaF();
	echo '<select id="cor" name="cor" style="style="background-color: #0000FF; width:60pt; font-size:8pt; font-family: verdana, arial, helvetica, sans-serif; padding-left: 5px; padding-right: 5px;" class=text size=1 onchange="env.cor.bgcolor=\'FF00FF\'">';
