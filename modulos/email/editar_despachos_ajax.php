...
function mudar_posicao_despacho_ajax($despacho_ordem, $despacho_id, $direcao, $despacho_usuario=0){
	...
	$objResposta->assign("despachos","innerHTML", gpw_passthrough($saida));
	return $objResposta;
	}
...
function incluir_despacho_ajax($despacho_usuario=0, $despacho_id=0, $despacho_nome='', $despacho_texto='', $despacho_anotacao=false, $despacho_despacho=false, $despacho_resposta=false){
	...
	$despacho_nome=previnirXSS(gpw_passthrough($despacho_nome));
	$despacho_texto=previnirXSS(gpw_passthrough($despacho_texto));
...
function editar_despacho($despacho_id){
	...
	$objResposta->assign("despacho_nome","value", gpw_passthrough($linha['despacho_nome']));
	$objResposta->assign("apoio1","value", gpw_passthrough($linha['despacho_texto']));		
	return $objResposta;
	}	
