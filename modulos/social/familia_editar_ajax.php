...
function adicionar_cultura_ajax($vetor='', $cultura='', $finalidade='', $quantitade=''){
	...
	$objResposta->assign("principais_culturas","innerHTML", gpw_passthrough($saida));
	return $objResposta;
	}			
...
function adicionar_animal_ajax($vetor='', $animal='', $finalidade='', $quantitade=''){
	...
	$objResposta->assign("principais_animais","innerHTML", gpw_passthrough($saida));
	return $objResposta;
	}			
...
function adicionar_irrigacao_ajax($vetor='', $cultura='', $finalidade='', $quantitade=''){
	...
	$objResposta->assign("principais_irrigacoes","innerHTML", gpw_passthrough($saida));
	return $objResposta;
	}			
