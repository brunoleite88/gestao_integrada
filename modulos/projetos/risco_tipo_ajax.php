...
function inserir_tipo($projeto_risco_tipo_id, $projeto_id, $projeto_risco_tipo_descricao=null, $projeto_risco_tipo_categoria=null, $projeto_risco_tipo_tipo=null, $projeto_risco_tipo_consequencia=null,$projeto_risco_tipo_probabilidade=null,$projeto_risco_tipo_impacto=null,$projeto_risco_tipo_acao=null, $projeto_risco_tipo_gatilho=null,$projeto_risco_tipo_resposta=null, $projeto_risco_tipo_usuario=null,$projeto_risco_tipo_status=null){
	...
	if (!$projeto_risco_tipo_id){
	  ...
	  $sql->Limpar();
		...
		$sql->adInserir('projeto_risco_tipo_descricao', previnirXSS(gpw_passthrough($projeto_risco_tipo_descricao)));
		$sql->adInserir('projeto_risco_tipo_categoria', previnirXSS(gpw_passthrough($projeto_risco_tipo_categoria)));
		$sql->adInserir('projeto_risco_tipo_tipo', previnirXSS(gpw_passthrough($projeto_risco_tipo_tipo)));
		$sql->adInserir('projeto_risco_tipo_consequencia', previnirXSS(gpw_passthrough($projeto_risco_tipo_consequencia)));
		$sql->adInserir('projeto_risco_tipo_probabilidade', previnirXSS(gpw_passthrough($projeto_risco_tipo_probabilidade)));
		$sql->adInserir('projeto_risco_tipo_impacto', previnirXSS(gpw_passthrough($projeto_risco_tipo_impacto)));
		$sql->adInserir('projeto_risco_tipo_severidade', $severidade);
		$sql->adInserir('projeto_risco_tipo_acao', previnirXSS(gpw_passthrough($projeto_risco_tipo_acao)));
		$sql->adInserir('projeto_risco_tipo_gatilho', previnirXSS(gpw_passthrough($projeto_risco_tipo_gatilho)));
		$sql->adInserir('projeto_risco_tipo_resposta', previnirXSS(gpw_passthrough($projeto_risco_tipo_resposta)));
		$sql->adInserir('projeto_risco_tipo_status', previnirXSS(gpw_passthrough($projeto_risco_tipo_status)));
		$sql->exec();
		$sql->Limpar();
		}
	else{
		...
		$sql->adAtualizar('projeto_risco_tipo_descricao', previnirXSS(gpw_passthrough($projeto_risco_tipo_descricao)));
		$sql->adAtualizar('projeto_risco_tipo_categoria', previnirXSS(gpw_passthrough($projeto_risco_tipo_categoria)));
		$sql->adAtualizar('projeto_risco_tipo_tipo', previnirXSS(gpw_passthrough($projeto_risco_tipo_tipo)));
		$sql->adAtualizar('projeto_risco_tipo_consequencia', previnirXSS(gpw_passthrough($projeto_risco_tipo_consequencia)));
		$sql->adAtualizar('projeto_risco_tipo_probabilidade', previnirXSS(gpw_passthrough($projeto_risco_tipo_probabilidade)));
		$sql->adAtualizar('projeto_risco_tipo_impacto', previnirXSS(gpw_passthrough($projeto_risco_tipo_impacto)));
		$sql->adAtualizar('projeto_risco_tipo_severidade', $severidade);
		$sql->adAtualizar('projeto_risco_tipo_acao', previnirXSS(gpw_passthrough($projeto_risco_tipo_acao)));
		$sql->adAtualizar('projeto_risco_tipo_gatilho', previnirXSS(gpw_passthrough($projeto_risco_tipo_gatilho)));
		$sql->adAtualizar('projeto_risco_tipo_resposta', previnirXSS(gpw_passthrough($projeto_risco_tipo_resposta)));
		$sql->adAtualizar('projeto_risco_tipo_status', previnirXSS(gpw_passthrough($projeto_risco_tipo_status)));
...
function lista_artefatos($projeto_id){
	...
	if ($tipos && count($tipos)) {
		...
		$saida.='<td style="background-color:#a6a6a6"><b>'.gpw_passthrough('Descrição').'</b></td>';
		$saida.='<td style="background-color:#a6a6a6"><b>Categoria</b></td>';
		$saida.='<td style="background-color:#a6a6a6"><b>Tipo</b></td>';
		$saida.='<td style="background-color:#a6a6a6"><b>'.gpw_passthrough('Consequência').'</b></td>';
		...
		$saida.='<td style="background-color:#a6a6a6"><b>'.gpw_passthrough('Ação').'</b></td>';
		$saida.='<td style="background-color:#a6a6a6"><b>Gatilho</b></td>';
		$saida.='<td style="background-color:#a6a6a6"><b>Resposta ao Risco</b></td>';
		$saida.='<td style="background-color:#a6a6a6"><b>'.gpw_passthrough('Responsável').'</b></td>';
	...
	foreach ($tipos as $tipo) {
		...
		$saida.='</td>';
		$saida.='<td>'.($tipo['projeto_risco_tipo_descricao'] ? gpw_passthrough($tipo['projeto_risco_tipo_descricao']) : '&nbsp;').'</td>';
		$saida.='<td>'.($tipo['projeto_risco_tipo_categoria'] ? gpw_passthrough($tipo['projeto_risco_tipo_categoria']) : '&nbsp;').'</td>';
		$saida.='<td>'.($tipo['projeto_risco_tipo_tipo'] ? gpw_passthrough($tipo['projeto_risco_tipo_tipo']) : '&nbsp;').'</td>';
		$saida.='<td>'.($tipo['projeto_risco_tipo_consequencia'] ? gpw_passthrough($tipo['projeto_risco_tipo_consequencia']) : '&nbsp;').'</td>';
		$saida.='<td>'.($tipo['projeto_risco_tipo_probabilidade'] ? gpw_passthrough($probabilidade[$tipo['projeto_risco_tipo_probabilidade']]) : '&nbsp;').'</td>';
		$saida.='<td>'.($tipo['projeto_risco_tipo_impacto'] ? gpw_passthrough($impacto[$tipo['projeto_risco_tipo_impacto']]) : '&nbsp;').'</td>';
		$saida.='<td>'.($tipo['projeto_risco_tipo_severidade'] ? gpw_passthrough($tipo['projeto_risco_tipo_severidade']) : '&nbsp;').'</td>';
		$saida.='<td>'.($tipo['projeto_risco_tipo_acao'] ? gpw_passthrough($tipo['projeto_risco_tipo_acao']) : '&nbsp;').'</td>';
		$saida.='<td>'.($tipo['projeto_risco_tipo_gatilho'] ? gpw_passthrough($tipo['projeto_risco_tipo_gatilho']) : '&nbsp;').'</td>';
		$saida.='<td>'.($tipo['projeto_risco_tipo_resposta'] ? gpw_passthrough($tipo['projeto_risco_tipo_resposta']) : '&nbsp;').'</td>';
		$saida.='<td>'.($tipo['projeto_risco_tipo_usuario'] ? gpw_passthrough($tipo['nome']) : '&nbsp;').'</td>';
		$saida.='<td>'.($tipo['projeto_risco_tipo_status'] ? gpw_passthrough($tipo['projeto_risco_tipo_status']) : '&nbsp;').'</td>';
		...
		$saida.='<a href="javascript: void(0);" onclick="if (confirm(\''.gpw_passthrough('Tem certeza que deseja excluir esta tipo do gerenciamento de risco?').'\')) {excluir_tipo('.$tipo['projeto_risco_tipo_id'].');}">'.imagem('icones/remover.png').'</a></td>';
		$saida.='</tr>';
		}
...
function editar_tipo($projeto_risco_tipo_id){
	...
	$categoria=array();
	foreach($RiscoCategoria as $chave => $valor) $categoria[gpw_passthrough($chave)]=gpw_passthrough($valor);
	$tipo_risco=array('Negativo'=>'Negativo', 'Positivo'=>'Positivo');
	$probabilidade=array(1=>'Baixa', 2 => gpw_passthrough('Média'), 3=>'Alta');
	$impacto=array(1=>'Baixo', 2 => gpw_passthrough('Médio'), 3=>'Alto');
	...
	$saida.='<td ><b>'.gpw_passthrough('Descrição').'</b></td>';
	$saida.='<td ><b>Categoria</b></td>';
	$saida.='<td ><b>Tipo</b></td>';
	$saida.='<td ><b>'.gpw_passthrough('Consequência').'</b></td>';
	$saida.='<td ><b>Probabilidade</b></td>';
	$saida.='<td ><b>Impacto</b></td>';
	$saida.='<td ><b>'.gpw_passthrough('Ação').'</b></td>';
	$saida.='<td ><b>Gatilho</b></td>';
	$saida.='<td ><b>Resposta ao Risco</b></td>';
	$saida.='<td ><b>'.gpw_passthrough('Responsável').'</b></td>';
	$saida.='<td ><b>Status</b></td>';
	$saida.='<td></td></tr><tr>';
		
	$saida.='<td valign=top><textarea name="projeto_risco_tipo_descricao" id="projeto_risco_tipo_descricao" class="textarea" style="width:100%">'.gpw_passthrough($tipo['projeto_risco_tipo_descricao']).'</textarea></td>';
	...
	$saida.='<td valign=top><textarea name="projeto_risco_tipo_consequencia" id="projeto_risco_tipo_consequencia" class="textarea" style="width:100%">'.gpw_passthrough($tipo['projeto_risco_tipo_consequencia']).'</textarea></td>';
	...
	$saida.='<td valign=top><textarea name="projeto_risco_tipo_acao" id="projeto_risco_tipo_acao" class="textarea" style="width:100%">'.gpw_passthrough($tipo['projeto_risco_tipo_acao']).'</textarea></td>';
	$saida.='<td valign=top><textarea name="projeto_risco_tipo_gatilho" id="projeto_risco_tipo_gatilho" class="textarea" style="width:100%">'.gpw_passthrough($tipo['projeto_risco_tipo_gatilho']).'</textarea></td>';
	$saida.='<td valign=top><textarea name="projeto_risco_tipo_resposta" id="projeto_risco_tipo_resposta" class="textarea" style="width:100%">'.gpw_passthrough($tipo['projeto_risco_tipo_resposta']).'</textarea></td>';
	$saida.='<td valign=top><table cellspacing=0 cellpadding=0><tr><td><input type="hidden" id="projeto_risco_tipo_usuario" name="projeto_risco_tipo_usuario" value="'.$tipo['projeto_risco_tipo_usuario'].'" /><input type="text" id="nome_responsavel" name="nome_responsavel" value="'.gpw_passthrough($tipo['nome']).'" style="width:120px;" class="texto" READONLY /></td><td valign=top><a href="javascript: void(0);" onclick="popResponsavel();">'.imagem('icones/usuarios.gif').'</a></td></tr></table></td>';
	$saida.='<td valign=top><textarea name="projeto_risco_tipo_status" id="projeto_risco_tipo_status" class="textarea" style="width:100%">'.gpw_passthrough($tipo['projeto_risco_tipo_status']).'</textarea></td>';
