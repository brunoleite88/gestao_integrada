...
foreach($existe as $linha) {
	...
	if ($ponto_relatorio_tipo=='data_custo' || $ponto_relatorio_tipo=='data_custo_resumido' || $ponto_relatorio_tipo=='data_custo_arquivo' || $ponto_relatorio_tipo=='data_custo_resumido_arquivo'){
		...
		if ($financeiro=='empenhado') $sql->adCampo('((recurso_ponto_gasto_empenhado*recurso_ponto_gasto_gasto)*((100+recurso_ponto_gasto_bdi)/100)) AS total, recurso_ponto_gasto_empenhado AS quantidade');
		elseif ($financeiro=='liquidado') $sql->adCampo('((recurso_ponto_gasto_liquidado*recurso_ponto_gasto_gasto)*((100+recurso_ponto_gasto_bdi)/100)) AS total, recurso_ponto_gasto_liquidado AS quantidade');
		elseif ($financeiro=='pago') $sql->adCampo('((recurso_ponto_gasto_pago*recurso_ponto_gasto_gasto)*((100+recurso_ponto_gasto_bdi)/100)) AS total, recurso_ponto_gasto_pago AS quantidade');
		else $sql->adCampo('((recurso_ponto_gasto_quantidade*recurso_ponto_gasto_gasto)*((100+recurso_ponto_gasto_bdi)/100)) AS total, recurso_ponto_gasto_quantidade AS quantidade');
