DELIMITER |
CREATE FUNCTION extrair(t1 varchar(50) CHARSET utf8mb4, t2 datetime)
RETURNS integer(100)
DETERMINISTIC
BEGIN
...
DELIMITER |
CREATE FUNCTION adiciona_data(t1 datetime, t2 float(100,3), t3 varchar(50) CHARSET utf8mb4)
RETURNS datetime
DETERMINISTIC
BEGIN
...
DELIMITER |
CREATE FUNCTION tamanho_caractere(t1 text CHARSET utf8mb4)
RETURNS int(100)
DETERMINISTIC
BEGIN
...
DELIMITER |
CREATE FUNCTION formatar_data(t1 datetime, t2 varchar(255) CHARSET utf8mb4)
...
DELIMITER |
CREATE FUNCTION concatenar_dois(t1 varchar(255) CHARSET utf8mb4, t2 varchar(255) CHARSET utf8mb4)
...
DELIMITER |
CREATE FUNCTION concatenar_tres(t1 varchar(255) CHARSET utf8mb4, t2 varchar(255) CHARSET utf8mb4, t3 varchar(255) CHARSET utf8mb4)
RETURNS text CHARSET utf8mb4
DETERMINISTIC
BEGIN
...
DELIMITER |
CREATE FUNCTION concatenar_quatro(t1 varchar(255) CHARSET utf8mb4, t2 varchar(255) CHARSET utf8mb4, t3 varchar(255) CHARSET utf8mb4, t4 varchar(255)CHARSET utf8mb4)
RETURNS text CHARSET utf8mb4
DETERMINISTIC
BEGIN
...
DELIMITER |
CREATE FUNCTION concatenar_cinco(t1 varchar(255) CHARSET utf8mb4, t2 varchar(255) CHARSET utf8mb4, t3 varchar(255) CHARSET utf8mb4, t4 varchar(255) CHARSET utf8mb4, t5 varchar(255) CHARSET utf8mb4)
RETURNS text CHARSET utf8mb4
DETERMINISTIC
BEGIN
